...
public class MySale extends Fragment implements FragmentChangeListener,AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ArrayList<HashMap<String, String>> Saleary = new ArrayList<HashMap<String, String>>();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Saleary.clear();
        new Getsale().execute(0);

        saleAdapter = new SaleAdapter(getActivity(),Saleary);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("data",Saleary.get(position));
     ...
     **/
    class Getsale extends AsyncTask<Integer, Void, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            ...
            if (!Saleary.contains(temp)) {
                Saleary.addAll(temp);
                Log.v("Saleary", "Saleary==" + Saleary);
            }
    ...
    public class SaleAdapter extends BaseAdapter {
        ...
        String date;
        public SaleAdapter(Context ctx, ArrayList<HashMap<String, String>> data) {
            mContext = ctx;
            Items = data;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                if (tempMap.get(Constants.TAG_STATUS).equalsIgnoreCase("shipped")) {
                    ...
                    holder.time.setText(getString(R.string.order_on) + " " + date);
                } else if (tempMap.get(Constants.TAG_STATUS).equalsIgnoreCase("paid")) {
                    holder.orderstatus.setVisibility(View.VISIBLE);
                    holder.orderstatus.setText(getString(R.string.paid));
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        holder.orderstatus.setBackground(getResources().getDrawable(R.drawable.blue_round_corner));
                    } else {
                        holder.orderstatus.setBackgroundDrawable(getResources().getDrawable(R.drawable.blue_round_corner));
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (!loading
            ...
            if(currentPage != 0){
                new Getsale().execute(currentPage);
                loading = true;
            }
        }
    }
