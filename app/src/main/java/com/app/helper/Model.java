...
public class Model {
	...
	public static void LoadModel(Context ctx) {
		...
		Items.add(new Item(1, R.drawable.s_cam, ctx.getString(R.string.scan)));
		Items.add(new Item(2, R.drawable.s_cam, ctx.getString(R.string.sell_your_stuff)));
		Items.add(new Item(3, R.drawable.s_message, ctx.getString(R.string.chat)));
		Items.add(new Item(4, R.drawable.s_category, ctx.getString(R.string.categories)));
		Items.add(new Item(5, R.drawable.s_user, ctx.getString(R.string.myprofile)));
