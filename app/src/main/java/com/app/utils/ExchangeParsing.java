                ...
                if (result != null) {
                    ...
                    if(exchange != null){
                        for(int i=0 ; i < exchange.length() ; i++){
                            ...
                            String exchangerImg = DefensiveClass.optString(temp, Constants.TAG_EXCHANGERIMG);
                            ...
                            if(mproduct != null){
                                ...
                                mitemName = String.valueOf(Html.fromHtml(DefensiveClass.optString(mproduct, Constants.TAG_ITEM_NAME)));
                            }
                            ...
                            if(eproduct != null){
                                ...
                                eitemName = String.valueOf(Html.fromHtml(DefensiveClass.optString(eproduct, Constants.TAG_ITEM_NAME)));
                            }
