        ...
        try {
            ...
            if (response.equalsIgnoreCase("true")) {
                ...
                for (int i = 0; i < result.length(); i++) {
                    ...
                    String review_id = DefensiveClass.optInt(temp, Constants.TAG_REVIEW_ID);
                    String rating = DefensiveClass.optInt(temp, Constants.TAG_RATING);
                    String review_title = DefensiveClass.optString(temp, Constants.TAG_REVIEW_TITLE);
                    String review_des = DefensiveClass.optString(temp, Constants.TAG_REVIEW_DES);
                    ...
                    map.put(Constants.TAG_REVIEW_TITLE, review_title);
                    map.put(Constants.TAG_REVIEW_DES, review_des);
