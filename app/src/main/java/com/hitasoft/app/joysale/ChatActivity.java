...
public class ChatActivity extends Activity implements OnClickListener,ChatCallbackAdapter,TextWatcher, OnScrollListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			//  JoysaleApplication.setupUI(ChatActivity.this, main);
	...
	private ArrayList<HashMap<String,String>> parsing(String url) {
		...
		try {
			...
			if(response.equalsIgnoreCase("true")){
				...
				JoysaleApplication.disabledialog(ChatActivity.this, json.optString("message"));
			}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			try{
				...
				if(tempMap.get("message") != null){
					holder.message.setText(JoysaleApplication.stripHtml(tempMap.get("message")));
				}
				...
				switch (tempMap.get(Constants.TAG_TYPE)) {
					...
					case "about":
						...
						holder.aboutMsg.setText(JoysaleApplication.stripHtml(tempMap.get("message")));
						break;
					case "offer":
						holder.main.setVisibility(View.GONE);
						holder.itemLay.setVisibility(View.VISIBLE);
