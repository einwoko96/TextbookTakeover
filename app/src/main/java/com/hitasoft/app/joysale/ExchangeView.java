	...
	private ArrayList<HashMap<String,String>> parsing(String url) {
		...
		try {
			...
			if(response.equalsIgnoreCase("true")){
				...
				JoysaleApplication.disabledialog(ExchangeView.this, json.optString("message"));
			} else {
		...
		protected void onPostExecute(String result) {
    		try {
				...
				if(status.equals("true")){
					...
					JoysaleApplication.dialog(ExchangeView.this, getResources().getString(R.string.alert), jobj.getString("message"));
					failed.setEnabled(true);
					success.setEnabled(true);
				}
