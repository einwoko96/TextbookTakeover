		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (jonj.getString("status").equalsIgnoreCase(
					...
					JoysaleApplication.dialog(LoginActivity.this, getString(R.string.alert), jonj.getString("message"));
				} else {
					dialog.dismiss();
					JoysaleApplication.dialog(LoginActivity.this, getString(R.string.alert), jonj.getString("message"));
				}
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (jonj.getString("status").equalsIgnoreCase("true")) {
					JoysaleApplication.dialog(LoginActivity.this, getString(R.string.success), jonj.getString("message"));
				}else{
					JoysaleApplication.dialog(LoginActivity.this, getString(R.string.alert), jonj.getString("message"));
				}
			} catch (JSONException e) {
