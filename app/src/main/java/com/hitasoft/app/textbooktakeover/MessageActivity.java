...
public class MessageActivity extends AppCompatActivity implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private void loadData() {
        try {
            ...
            if (Messagepageitems.size() == 0) {
                if (TextbookTakeoverApplication.isNetworkAvailable(MessageActivity.this)) {
            ...
            if (response.equalsIgnoreCase("true")) {
                ...
                if (result != null) {
                    ...
                    for (int i = 0; i < result.length(); i++) {
                        ...
                        String image = DefensiveClass.optString(temp, Constants.TAG_USERIMAGE);
                ...
                TextbookTakeoverApplication.disabledialog(MessageActivity.this, json.optString("message"));
            } else {
    ...
    public class HomeAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                holder.time.setText(TextbookTakeoverApplication.getTimeAgo(timestamp, mContext));
    ...
    protected void onPause() {
        super.onPause();
        TextbookTakeoverApplication.unregisterReceiver(MessageActivity.this);
    }

    @Override
    protected void onResume() {
        super.onResume();
        TextbookTakeoverApplication.registerReceiver(MessageActivity.this);
        if (fromChat) {
            currentPage = 0;
            pulldown = true;
            fromChat = false;
