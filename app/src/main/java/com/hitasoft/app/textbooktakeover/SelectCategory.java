...
public class SelectCategory extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        padding = TextbookTakeoverApplication.dpToPx(SelectCategory.this, 15);
    ...
    protected void onPause() {
        ...
        TextbookTakeoverApplication.unregisterReceiver(SelectCategory.this);
    }
    ...
    protected void onResume() {
        ...
        TextbookTakeoverApplication.registerReceiver(SelectCategory.this);
    }
